    ...
    <>
      ...
      >
        ...
        <div className="hidden md:flex items-center space-x-3 px-6 h-18 border-b border-white/5">
          ...
          <div>
            <div className="font-bold text-white text-md tracking-wider flex items-center gap-1.5">
              <span className="text-glass-indigo">eTopia</span>
              <Sparkles className="h-3 w-3 text-indigo-400 fill-indigo-400" />
            </div>
            <div className="text-[10px] text-slate-400 tracking-wide uppercase font-mono font-bold leading-none mt-0.5">
